...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $contentManager->addActor($_POST['acteurnaam']);
        redirect('admin_dashboard.php?success=Acteur succesvol toegevoegd');
    } catch (\PDOException $e) {
        $message = ($e->getCode() === '23000') ? "Fout: Acteur bestaat al." : "Er is een fout opgetreden.";
    }
}
...
<div class="admin-content">
    ...
    <form method="POST">
        ...
        <input type="text" name="acteurnaam" required style="width: 100%;"><br>
        <button type="submit">Acteur Toevoegen</button>
    </form>
